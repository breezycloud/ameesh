...
public class SalaryBonusReport(SalaryBonusReportData Model) : IDocument
{
    ...
    void ComposeHeader(IContainer container)
    {
        ...
        container.ShowOnce().Row(row =>
        {
            row.RelativeItem().Column(column =>
            {
                ...
                column.Item().Text($"{StringConverter.ConvertToMonth(Model.Month!.Value)} {Model.Year} Salary Bonus Report");
            });
        });
    }
